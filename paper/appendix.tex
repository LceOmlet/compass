...
\subsection{Proposal matching implementation}
...
least one proposal score below the configured maximum.  Let $m\le w$ be the
...
remaining budget, and persistent search state.  A new observation replaces an
...
\begin{algorithmic}[1]
\Require committed search state $\mathcal H_t$, wave width $w$, active cutoff $\rho$
