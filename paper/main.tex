...
under a fixed rollout budget.  Candidates are evaluated on different subsets
of instances, leaving an uneven record for deciding which candidates to revise
next.  We introduce \method{}, which turns accumulated evaluation results into
relative credit to guide subsequent proposals.  On each
...
Qwen3-8B and GPT-5.4-nano.  On Qwen3-8B, it improves over GEPA by $11.8$
percentage points on average and $36.7$ points on AIME-2025.  Ablations on
