...
% Native-size vector graphic: 65.5 mm wide; all text is at least 8 pt.
...
\tikzset{
  ...
  label/.style={font=\fontsize{8}{8.6}\selectfont, text=ink, inner sep=1pt},
  axisrange/.style={font=\fontsize{8}{8.6}\selectfont, text=seed, inner sep=1pt},
}

% Ranges include every method, with margin on both ends.
\def\axismin{{40,25,30,75,15,40}}
\def\axismax{{70,45,60,95,60,70}}
...
\path[use as bounding box] (-3.275,-3.05) rectangle (3.275,2.85);
\begin{scope}[yshift=0.50cm]
  ...
  \radardata{compass}{64.67,43.37,54.00,86.91,57.33,66.67}
  ...
  \node[axisrange,anchor=east] at (-1.76,-1.16) {15--60};
  \node[label,anchor=east,align=right] at (-1.76,1.21) {LiveBench-\\Math};
  \node[axisrange,anchor=east] at (-1.76,0.76) {40--70};
\end{scope}
